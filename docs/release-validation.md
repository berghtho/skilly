...
| 4. Cursor pstack source | Exact 44-Skill fixture, path identity, exact `poteto-mode`/`Poteto Mode` aliases, and complete-folder acquisition | Current URL at an exact recorded commit; any count other than 44 fails closed |
